...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let jsonUrl = Bundle.main.url(forResource: "JsonData", withExtension: "json")
        ...
        do {
            ...
            assetCombiner.combine(json: jsonArray)
        } catch {
            return
        }
...
//    print("making vid")
//
//    let path = Bundle.main.path(forResource: "IMG_8487", ofType:"MOV")
//    let fileURL = NSURL(fileURLWithPath: path!)
//
//    let vid = AVURLAsset(url: fileURL as URL)
//
//    let path2 = Bundle.main.path(forResource: "IMG_8488", ofType:"MOV")
